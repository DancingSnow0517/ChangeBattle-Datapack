...
execute if score @s ChangeBattle matches 1.. run summon minecraft:item ~ ~1 ~ {Tags:["ChangeBattle"],Item:{id:"minecraft:enchanted_book",Count:1b,tag:{StoredEnchantments:[{id:"minecraft:fortune",lvl:1}]}}}
